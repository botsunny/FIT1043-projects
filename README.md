This repository collects the reports (as well as the Jupyter Notebook files to generate them) I wrote for two of the assignments given in FIT1043 - Introduction to data science at Monash University.
